    ...
    <>
      <div className="w-[200px]">
        <ul>
            ...
            {submenuOpen && (
              <ul className="submenu p-2">
                <li onClick={handleSubmenuClick}>
                  <a
                    onClick={() => handleRounter2("salesqoutation")}
                ...
                <li onClick={handleSubmenuClick}>
                  <a
                    onClick={() => handleRounter2("salesorder")}
          ...
          <li
            className={`p-2 linav ${routerName === "inquiry" ? "active" : ""}`}
          ...
          <li
            className={`p-2 linav ${routerName === "reports" ? "active" : ""}`}
          ...
          <li
            className={`p-2 linav ${routerName === "setup" ? "active" : ""}`}
