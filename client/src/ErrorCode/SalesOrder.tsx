...
export default function SalesOrder() {
  ...
  //     // Handle the error, e.g., display a message to the user or take other actions.
  //   }
  // };
  ...
  //     setItemDataList(item.data);
  //   } catch (error) {
  //     console.error("Error in onAddheaderItems:", error);
  //   }
  // };
  ...
  // const onAddHeaderTaxCode = async (cardCodex: any, whseCodex: any) => {
  //   try {
  //     // Make a GET request to the specified tax-code endpoint with cardCodex and whseCodex
  //     const taxcode = await axios.get(
  //       `${fetchAPI}/tax-code/${cardCodex}/${whseCodex}`
  //     );

  //     // Log the retrieved tax code data to the console
  //     console.log("Tax Code", taxcode.data);

  //     // Set the tax code data using the retrieved data
  //     settaxCodeData(taxcode.data);
  //   } catch (error) {
  //     // Handle errors, log or display an error message
  //     console.error("Error in onAddHeaderTaxCode:", error);
  //     // You may want to handle the error more gracefully, e.g., show a user-friendly message
  //   }
  // };
